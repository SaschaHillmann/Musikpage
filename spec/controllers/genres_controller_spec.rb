  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved genre as @genre" do
        ...
        post :create, {:genre => { "id" => "invalid value" }}, valid_session
        assigns(:genre).should be_a_new(Genre)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested genre" do
        ...
        Genre.any_instance.should_receive(:update_attributes).with({ "id" => "1" })
        put :update, {:id => genre.to_param, :genre => { "id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the genre as @genre" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Genre.any_instance.stub(:save).and_return(false)
        put :update, {:id => genre.to_param, :genre => { "id" => "invalid value" }}, valid_session
        assigns(:genre).should eq(genre)
      end
